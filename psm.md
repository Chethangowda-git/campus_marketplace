...
A comprehensive SQL Server database system for a student-to-student marketplace platform at Northeastern University, featuring encryption, escrow management, dispute resolution, and audit logging.

---

## Overview

This document explains how to set up the `campus_marketplace` SQL Server database, what each `.sql` file does, and how to verify that:
...
### Stored Procedures (End-to-End Flows)
...
- Run scripts in the order specified in the "Recommended Execution Order" section
- Use verification queries to quickly verify everything is wired correctly
